...
const TermsAndConditions: React.FC<TermsAndConditionsProps> = ({ onAccept }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ color: "#CDA434", fontFamily: "cursive", textAlign: "center" }}>Terms and Conditions</h2>
        <p style={{ color: "#CDA434", fontFamily: "cursive" }}>
        ...
        <ol style={{ color: "#CDA434", fontFamily: "cursive" }}>
          <li>
